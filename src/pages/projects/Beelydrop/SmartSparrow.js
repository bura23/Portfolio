...
import imageUxresearchlarge from 'assets/Ux-research-large.png'
import imageUxresearch from 'assets/Ux-research.png'
...
// import pdfFile from "../../../../public/BeelyDropUxresearch.pdf";
import {
  ProjectBackground,
  ProjectContainer,
  ProjectHeader,
  ...
  return (
    <Fragment>
      <ProjectContainer className="spr">
        ...
        <ProjectSection>
          <ProjectTextRow>
            <ProjectSectionHeading>BeelyDrop</ProjectSectionHeading>
            <ProjectSectionText>
            Beelydrop is a Nigerian-based e-commerce company that is aiming to revolutionize 
            the shopping experience of Nigerian shoppers with amazing user experience and content. 
            They are committed to delivering exceptional user experiences and enriching content, 
            aiming to revolutionize the retail journey for shoppers across Nigeria.
            </ProjectSectionText>
          </ProjectTextRow>
        </ProjectSection>
        <ProjectSection light={isDark}>
          <ProjectSectionContent>
            ...
            <ProjectTextRow>
              ...
              <ProjectSectionText>
                To streamline the design process for such a large project, it was important to lay the foundations with a strong,
            ...
            <ProjectSectionColumns width="full">
              <ProjectSectionContent width="full">
                <ProjectTextRow width="s">
                  ...
                  <ProjectSectionText>
                  User experience research plays a pivotal role in the design and development 
                  of a digital platform like Beelydrop. This is because Beelydrop's primary 
                  objective is to craft personalized user experiences and cater to a specific target audience, 
                  ensuring an exceptional and tailored customer journey.
                  </ProjectSectionText>
                </ProjectTextRow>
              </ProjectSectionContent>
              <div className={styles.video}>
      {/* <Document file={"../../../../public/BeelyDropUxresearch.pdf"} onLoadSuccess={onDocumentLoadSuccess}>
      ...
      {/* <p>
        Page {pageNumber} of {numPages}
              ...
              <a href="/BeelyDrop Ux research.pdf"className={styles.image} download="BeelyDrop Ux research">Download </a>
              <Image
              raised
              key={themeId}
              srcSet={
                isDark
                  ? [imageUxresearchlarge,imageUxresearch]
                  : [imageUxresearchlarge,imageUxresearch]
              }
              placeholder={
                isDark
